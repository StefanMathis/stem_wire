...
[`Wire`]: https://docs.rs/stem_wire/0.1.3/stem_wire/wire/trait.Wire.html
[`RoundWire`]: https://docs.rs/stem_wire/0.1.3/stem_wire/round/struct.RoundWire.html
[`RectangularWire`]: https://docs.rs/stem_wire/0.1.3/stem_wire/rectangular/struct.RectangularWire.html
[`StrandedWire`]: https://docs.rs/stem_wire/0.1.3/stem_wire/stranded/struct.StrandedWire.html
[`SffWire`]: https://docs.rs/stem_wire/0.1.3/stem_wire/sff/struct.SffWire.html
[`CastWire`]: https://docs.rs/stem_wire/0.1.3/stem_wire/cast/struct.CastWire.html
[`resistance`]: https://docs.rs/stem_wire/0.1.3/stem_wire/resistance/
...
The full API documentation is available at <https://docs.rs/stem_wire/0.1.3/stem_wire>.
